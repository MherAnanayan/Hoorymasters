...
function SvgMaleSelected1(props) {
  return (
    <svg width={140} height={140} viewBox="0 0 142 142" {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <g transform="translate(21 13)">
          <use
            fill="#000"
            filter="url(#male-selected-1_svg__a)"
            xlinkHref="#male-selected-1_svg__b"
          />
          <use
            stroke="#600BFB"
            strokeWidth={3}
        ...
        <path
          ...
          fill="url(#male-selected-1_svg__c)"
...
export default SvgMaleSelected1;
