    ...
    <svg width={140} height={140} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <g transform="translate(20 12)">
          <use
            fill="#000"
            filter="url(#male-5_svg__a)"
            xlinkHref="#male-5_svg__b"
          />
          <use fill="#FFF" xlinkHref="#male-5_svg__b" />
        </g>
        <path
